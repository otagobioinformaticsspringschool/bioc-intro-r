...
This episode is skipped for Otago Bioformatics Spring School 2024 Intro to R
...
```{r, message=FALSE, purl=FALSE, echo=FALSE}
...
```{r, message=FALSE, purl=TRUE, eval=FALSE}
rna <- read_csv("~/obss_2024/intro_r/rnaseq.csv")
