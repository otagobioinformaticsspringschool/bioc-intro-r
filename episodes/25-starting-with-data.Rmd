...
This was the original code in the lesson for getting the data.
...
The data for use at Otago Bioinformatics Spring School is found in `~/obss_2024/intro_r/rnaseq.csv`.
...
rna <- read.csv("~/obss_2024/intro_r/rnaseq.csv")
```
...
```{r, eval=TRUE, purl=FALSE, echo=FALSE}
...
rna <- read.table(file = "~/obss_2024/intro_r/rnaseq.csv",
                  sep = ",",
                  header = TRUE)
```
